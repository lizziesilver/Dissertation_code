...
graphGenMethodVec = c("forwardedges", "scalefree", "uniform")
...
setMaxIndegree = function(numNodes){
  return(numNodes - 1)
}
setMaxOutdegree = function(numNodes){
  return(numNodes - 1)
}
connected = FALSE
...
alpha = 0.8 #double  
beta = 0.02 # alpha + beta must be less than 1
delta_in = 3
delta_out = 0.01
