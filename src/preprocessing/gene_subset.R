...
vargenes <- read.csv("Raw/MESCs/KleinData/Documentation/mmc3-sheet1-variable-genes-in-es-cells.csv", 
                     stringsAsFactors=F)
...
# list of TFs
tf_list <- readLines("Processed/MESCs/tf_list.txt")
...
# write to file
write(genes_included, file="Processed/MESCs/gene_subset.txt")
